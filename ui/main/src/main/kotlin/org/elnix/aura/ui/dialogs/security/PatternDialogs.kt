...
import org.elnix.aura.ui.base.animation.slideInVerticalBouncyUp
import org.elnix.aura.ui.base.animation.slideOutVerticalBouncyUp
import org.elnix.aura.ui.base.components.AnimatedFab
import org.elnix.aura.ui.base.modifiers.selfAlignHorizontally
...
import org.elnix.aura.ui.dragon.text.DialogDescription
...
fun PatternSetup(
    ...
    if (showWarningDialog) {
        UserValidation(
            ...
            doNotRemindMeAgain = { doNotRemindMeWarningDialog = false },
            onDismiss = onDismiss
        ) {
            onPinSet(firstPattern)
        }
